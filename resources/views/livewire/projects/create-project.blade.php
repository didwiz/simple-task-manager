        ...
        <div class="space-y-12">
            <div class="grid grid-cols-1 pb-12 border-b gap-x-8 gap-y-10 border-gray-900/10 md:grid-cols-3">
                <div>
                    ...
                    <p class="mt-1 text-sm leading-6 text-gray-600">Provide required information about this project.</p>
                </div>
                ...
                <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                    ...
                    <div class="col-span-full">
                        <label for="desc"
                            class="block text-sm font-medium leading-6 text-gray-900">Descripton</label>
                        <div class="mt-2">
